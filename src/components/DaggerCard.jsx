    ...
    >
      <Box p={4}>
        <Text as='samp' fontSize="m" mb={4}>Amount: </Text>
				<Text as='samp'color={textColor} >${dagger.loanAmount}</Text>
				<br />
        ...
        <Text as='samp' fontSize="m"  mb={4}>monthly PI: </Text>
				<Text as='samp'color={textColor} >${dagger.monthlyPI}%</Text>
				<br />

        <Text as='samp' fontSize="m"  mb={4}>Total Interest: </Text>
				<Text as='samp'color={textColor} >${dagger.totalInterest}</Text>
				<br />
